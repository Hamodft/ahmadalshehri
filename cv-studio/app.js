(function () {
  ...
  var THEMES = {
    ...
    retail: { en: ['retail','store','stores','channel','dealer','distributor','merchandising','point of sale','in-store'], ar: ['التجزئة','متجر','المتاجر','القنوات','موزع','موزعين','نقاط البيع','داخل المتجر'], label: { en: 'Retail & Channel Operations', ar: 'عمليات التجزئة والقنوات' }, scope: { en: 'National Retail Operations', ar: 'عمليات التجزئة على مستوى المملكة العربية السعودية' } },
  ...
  async function prepareFrame() {
    ...
    frame.tabIndex = -1;
    frame.style.cssText = 'position:fixed;left:0;top:0;width:1050px;height:1400px;border:0;opacity:1;z-index:-1;pointer-events:none;';
